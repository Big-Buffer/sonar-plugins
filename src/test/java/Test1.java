...
public class Test1 {
    ...
    public void test1() {
        CheckVerifier.newVerifier()
                .withCheck(new LambdaUpdateWrapperEqConditionCheck())
                .onFile("src/test/resources/TestClass.java")
                .verifyIssues();
    }
        ...
        public void testMissingEqCondition() {
            ...
            CheckVerifier.newVerifier()
                    .onFile("src/test/files/ScheduleService.java")
                    .withCheck(check)
                    .verifyIssues();
        }
    ...
    public void testMissingEqCondition2() {
        LambdaUpdateWrapperEqConditionCheck check = new LambdaUpdateWrapperEqConditionCheck();
        CheckVerifier.newVerifier()
                .onFile("src/test/files/LambdaUpdateWrapperEqConditionCheck.java")
                .withCheck(check)
                .verifyIssues();
    }
    ...
    public void testWithEqCondition() {
        LambdaUpdateWrapperEqConditionCheck check = new LambdaUpdateWrapperEqConditionCheck();
        CheckVerifier.newVerifier()
                .onFile("src/test/files/LambdaUpdateWrapperEqConditionCheckWithEq.java")
                .withCheck(check)
                .verifyNoIssues();
    }
}
